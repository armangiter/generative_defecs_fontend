import {
  require_CoreInternals,
  require_Global,
  require_lib
} from "./chunk-EWY32KUY.js";
import {
  require_scheduler
} from "./chunk-FCJNIEWI.js";
import {
  require_react
...
var { ReactCurrentOwner, ReactCurrentDispatcher } = React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
function useFiber() {
...
var StageWrap = (props) => {
  const container = import_react.default.useRef();
  const stage = import_react.default.useRef();
  const fiberRef = import_react.default.useRef();
