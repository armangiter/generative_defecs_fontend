...
var _excluded22 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "slotProps", "slots", "theme"];
...
var Modal = React28.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime35.jsx)(ModalUnstyled_default, _extends({
    slots: {
      root: RootSlot,
...
var _excluded33 = ["checked", "className", "componentsProps", "control", "disabled", "disableTypography", "inputRef", "label", "labelPlacement", "name", "onChange", "slotProps", "value"];
...
var FormControlLabel = React40.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  if (label != null && label.type !== Typography_default && !disableTypography) {
    label = (0, import_jsx_runtime46.jsx)(Typography_default, _extends({
      component: "span"
    }, typographySlotProps, {
  ...
  return (0, import_jsx_runtime47.jsxs)(FormControlLabelRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
  }, other, {
...
var FormGroup = React41.forwardRef(function FormGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime48.jsx)(FormGroupRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var FormHelperText = React42.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime49.jsx)(FormHelperTextRoot, _extends({
    as: component,
    ownerState,
    className: clsx_m_default(classes.root, className),
    ref
...
var Grid = React45.forwardRef(function Grid2(inProps, ref) {
  ...
  return (0, import_jsx_runtime51.jsx)(GridContext_default.Provider, {
    value: columns,
    children: (0, import_jsx_runtime51.jsx)(GridRoot, _extends({
      ownerState,
      className: clsx_m_default(classes.root, className),
      as: component,
      ref
  ...
  return (0, import_jsx_runtime62.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime62.jsx)(InputAdornmentRoot, _extends({
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime62.jsx)(Typography_default, {
        color: "text.secondary",
        children
      }) : (0, import_jsx_runtime63.jsxs)(React57.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span2 || (_span2 = (0, import_jsx_runtime62.jsx)("span", {
            className: "notranslate",
            children: "​"
          }))
        ) : null, children]
...
var InputLabel = React58.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime64.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx_m_default(classes.root, className)
...
true ? InputLabel.propTypes = {
   ...
   * @default 'normal'
   */
  size: import_prop_types52.default.oneOfType([import_prop_types52.default.oneOf(["normal", "small"]), import_prop_types52.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var List = React61.forwardRef(function List2(inProps, ref) {
  ...
  return (0, import_jsx_runtime67.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime66.jsxs)(ListRoot, _extends({
      as: component,
      className: clsx_m_default(classes.root, className),
      ref,
      ownerState
...
var ListItemIcon = React66.forwardRef(function ListItemIcon2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiListItemIcon"
  });
...
var _excluded55 = ["children", "className", "disableTypography", "inset", "primary", "primaryTypographyProps", "secondary", "secondaryTypographyProps"];
...
var ListItemText = React67.forwardRef(function ListItemText2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiListItemText"
  });
  ...
  const {
    dense
  } = React67.useContext(ListContext_default);
...
var Popover = React69.forwardRef(function Popover2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiPopover"
  });
  ...
  return (0, import_jsx_runtime77.jsx)(PopoverRoot, _extends({
    BackdropProps: {
      invisible: true
    },
    className: clsx_m_default(classes.root, className),
    ...
    children: (0, import_jsx_runtime77.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime77.jsx)(PopoverPaper, _extends({
        elevation
      }, PaperProps, {
        ref: handlePaperRef,
        className: clsx_m_default(classes.paper, PaperProps.className)
...
var Menu = React70.forwardRef(function Menu2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiMenu"
  });
...
var _excluded59 = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"];
...
var MobileStepper = React72.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime80.jsxs)(MobileStepperRoot, _extends({
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime80.jsxs)(React72.Fragment, {
      ...
      children: [...new Array(steps)].map((_, index) => (0, import_jsx_runtime81.jsx)(MobileStepperDot, {
...
var NativeSelectInput = React73.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime83.jsxs)(React73.Fragment, {
...
var _excluded62 = ["className", "children", "classes", "IconComponent", "input", "inputProps", "variant"];
...
var NativeSelect = React74.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  return (0, import_jsx_runtime84.jsx)(React74.Fragment, {
...
var _span3;
var _excluded63 = ["children", "classes", "className", "label", "notched"];
...
var _excluded64 = ["components", "fullWidth", "inputComponent", "label", "multiline", "notched", "slots", "type"];
...
var OutlinedInput = React76.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime87.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime87.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime86.jsxs)(React76.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var SelectInput = React85.forwardRef(function SelectInput2(props, ref) {
  const {
    "aria-describedby": ariaDescribedby,
  ...
  const handleDisplayRef = React85.useCallback((node) => {
  ...
  return (0, import_jsx_runtime96.jsxs)(React85.Fragment, {
    children: [(0, import_jsx_runtime95.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span4 || (_span4 = (0, import_jsx_runtime95.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
...
var Select = React86.forwardRef(function Select2(inProps, ref) {
  const props = useThemeProps2({
    name: "MuiSelect",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime97.jsx)(React86.Fragment, {
...
function SliderValueLabel(props) {
  ...
  }, (0, import_jsx_runtime99.jsxs)(React87.Fragment, {
  ...
  return (0, import_jsx_runtime101.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime100.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime100.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (
        ...
        (0, import_jsx_runtime100.jsx)(ValueLabelComponent, _extends({}, !isHostComponent(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
...
true ? Stack.propTypes = {
   ...
   */
  divider: import_prop_types80.default.node,
  /**
   ...
   * @default false
   */
  useFlexGap: import_prop_types80.default.bool
} : void 0;
...
true ? Step.propTypes = {
   ...
   * @default false
   */
  expanded: import_prop_types81.default.bool,
  /**
   ...
   * The prop defaults to the value inherited from the parent Stepper component.
   */
  last: import_prop_types81.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
true ? StepLabel.propTypes = {
  ...
  componentsProps: import_prop_types83.default.shape({
    label: import_prop_types83.default.object
  }),
  /**
   * If `true`, the step is marked as failed.
   * @default false
   ...
   */
  StepIconComponent: import_prop_types83.default.elementType,
  /**
   * Props applied to the [`StepIcon`](/material-ui/api/step-icon/) element.
   */
  StepIconProps: import_prop_types83.default.object,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
true ? Stepper.propTypes = {
   ...
   */
  connector: import_prop_types87.default.element,
  /**
   * If set the `Stepper` will not assist in controlling steps for linear flow.
   * @default false
   */
  nonLinear: import_prop_types87.default.bool,
  /**
   * The component orientation (layout flow direction).
   * @default 'horizontal'
   */
...
true ? SwipeArea.propTypes = {
   ...
   */
  anchor: import_prop_types88.default.oneOf(["left", "top", "right", "bottom"]).isRequired,
  /**
   * @ignore
   */
   ...
   */
  width: import_prop_types88.default.number.isRequired
} : void 0;
...
var SwipeableDrawer = React103.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime119.jsxs)(React103.Fragment, {
    children: [(0, import_jsx_runtime118.jsx)(Drawer_default, _extends({
      ...
      onClose,
      ref
    }, other)), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime118.jsx)(NoSsr_default, {
...
true ? SwipeableDrawer.propTypes = {
   ...
   * @default false
   */
  allowSwipeInChildren: import_prop_types89.default.oneOfType([import_prop_types89.default.bool, import_prop_types89.default.func]),
  /**
   * @ignore
   */
  anchor: import_prop_types89.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * The content of the component.
   */
   ...
   * @default false
   */
  disableBackdropTransition: import_prop_types89.default.bool,
  /**
   * If `true`, touching the screen near the edge of the drawer will not slide in the drawer a bit
   * to promote accidental discovery of the swipe gesture.
   * @default false
   */
  disableDiscovery: import_prop_types89.default.bool,
  /**
   * If `true`, swipe to open is disabled. This is useful in browsers where swiping triggers
   * navigation actions. Swipe to open is disabled on iOS browsers by default.
   * @default typeof navigator !== 'undefined' && /iPad|iPhone|iPod/.test(navigator.userAgent)
   */
  disableSwipeToOpen: import_prop_types89.default.bool,
  /**
   * @ignore
   */
  hideBackdrop: import_prop_types89.default.bool,
  /**
   * Affects how far the drawer must be opened/closed to change its state.
   * Specified as percent (0-1) of the width of the drawer
   * @default 0.52
   */
  hysteresis: import_prop_types89.default.number,
  /**
   ...
   * @default 450
   */
  minFlingVelocity: import_prop_types89.default.number,
  /**
   * @ignore
   */
  ModalProps: import_prop_types89.default.shape({
    BackdropProps: import_prop_types89.default.shape({
      component: elementTypeAcceptingRef_default
    })
  }),
  /**
   ...
   */
  SwipeAreaProps: import_prop_types89.default.object,
  /**
   * The width of the left most (or right most) area in `px` that
   * the drawer can be swiped open from.
   * @default 20
   */
  swipeAreaWidth: import_prop_types89.default.number,
  /**
   * The duration for the transition, in milliseconds.
   * You may specify a single timeout for all transitions, or individually with an object.
   * @default {
   ...
   * }
   */
  transitionDuration: import_prop_types89.default.oneOfType([import_prop_types89.default.number, import_prop_types89.default.shape({
   ...
   * @ignore
   */
  variant: import_prop_types89.default.oneOf(["permanent", "persistent", "temporary"])
} : void 0;
...
true ? Switch.propTypes = {
   ...
   * The icon to display when the component is checked.
   */
  checkedIcon: import_prop_types90.default.node,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default 'primary'
   */
  color: import_prop_types90.default.oneOfType([import_prop_types90.default.oneOf(["default", "primary", "secondary", "error", "info", "success", "warning"]), import_prop_types90.default.string]),
  /**
   * The default checked state. Use when the component is not controlled.
   */
  defaultChecked: import_prop_types90.default.bool,
  /**
   * If `true`, the component is disabled.
   */
   ...
   * @default false
   */
  edge: import_prop_types90.default.oneOf(["end", "start", false]),
  /**
   * The icon to display when the component is unchecked.
   */
...
var Tab = React105.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime122.jsxs)(TabRoot, _extends({
    focusRipple: !disableFocusRipple,
    className: clsx_m_default(classes.root, className),
    ref,
    role: "tab",
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime122.jsxs)(React105.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime122.jsxs)(React105.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
true ? Tab.propTypes = {
   ...
   * The icon to display.
   */
  icon: import_prop_types91.default.oneOfType([import_prop_types91.default.element, import_prop_types91.default.string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: import_prop_types91.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * The label element.
   */
   ...
   * @default false
   */
  wrapped: import_prop_types91.default.bool
} : void 0;
var Tab_default = Tab;
...
var TextField = React120.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime138.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime139.jsxs)(TextFieldRoot, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime138.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime138.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime138.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
